...
#pragma warning disable
    ...
    public partial class CalcClient: ICalcService
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public CalcClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
        ...
        public async System.Threading.Tasks.Task<int> AddAsync(int a, int b, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (a == null)
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Calc/add/{a}/{b}");
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<int> MulAsync(int a, int b, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (a == null)
                throw new System.ArgumentNullException("a");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Calc/mul/{a}/{b}");
            urlBuilder_.Replace("{a}", System.Uri.EscapeDataString(ConvertToString(a, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{b}", System.Uri.EscapeDataString(ConvertToString(b, System.Globalization.CultureInfo.InvariantCulture)));

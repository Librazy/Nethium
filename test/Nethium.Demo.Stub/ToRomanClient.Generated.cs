...
#pragma warning disable
    ...
    public partial class ToRomanClient: IToRomanService
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public ToRomanClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
        ...
        public async System.Threading.Tasks.Task<string> ToRomanAsync(ushort num, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (num == null)
                throw new System.ArgumentNullException("num");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/ToRoman/{num}");
